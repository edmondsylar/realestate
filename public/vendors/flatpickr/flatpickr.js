...
!function (e, t) {
                ...
                if (e instanceof Date) l = new Date(e.getTime()); else if ("string" != typeof e && void 0 !== e.toFixed) l = new Date(e); else if ("string" == typeof e) {
                    ...
                    if ("today" === u) l = new Date, a = !0; else if (/Z$/.test(u) || /GMT$/.test(u)) l = new Date(e); else if (i && i.parseDate) l = i.parseDate(e, s); else {
                        ...
                        for (var f = void 0, m = [], h = 0, v = 0, D = ""; h < s.length; h++) {
                            ...
                            if (p[w] && !C) {
                                D += p[w];
                                var y = new RegExp(D).exec(e);
                                y && (f = !0) && m["Y" !== w ? "push" : "unshift"]({fn: g[w], val: y[++v]})
                            } else b || (D += ".");
    ...
    function M(n, f) {
        ...
        function x(e) {
            if (0 !== g.selectedDates.length) {
                void 0 !== e && "blur" !== e.type && function (e) {
                    ...
                    var a = parseFloat(n.getAttribute("data-min")), r = parseFloat(n.getAttribute("data-max")),
                        l = parseFloat(n.getAttribute("data-step")), c = parseInt(n.value, 10),
                ...
                T(), he(), g._input.value !== t && g._debouncedChange()
            }
        }
        ...
        function Y(e, t, n) {
            var a = e && e.target, i = n || a && a.parentNode && a.parentNode.firstChild, o = fe("increment");
        ...
        function j(e, t, n, a) {
            ...
            }(t) && !me(t) && o.classList.add("inRange"), g.weekNumbers && 1 === g.config.showMonths && "prevMonthDay" !== e && n % 7 == 1 && g.weekNumbers.insertAdjacentHTML("beforeend", "<span class='flatpickr-day'>" + g.config.getWeek(t) + "</span>"), ue("onDayCreate", o), o
        }
        ...
        function K() {
            ...
            i.setAttribute("aria-label", g.l10n.yearAriaLabel), g.config.minDate && i.setAttribute("data-min", g.config.minDate.getFullYear().toString()), g.config.maxDate && (i.setAttribute("data-max", g.config.maxDate.getFullYear().toString()), i.disabled = !!g.config.minDate && g.config.minDate.getFullYear() === g.config.maxDate.getFullYear());
        ...
        function $(e, t) {
            ...
            n < 0 && !0 === g._hidePrevMonthArrow || n > 0 && !0 === g._hideNextMonthArrow || (g.currentMonth += n, (g.currentMonth < 0 || g.currentMonth > 11) && (g.currentYear += g.currentMonth > 11 ? 1 : -1, g.currentMonth = (g.currentMonth + 12) % 12, ue("onYearChange")), B(), ue("onMonthChange"), ge())
        }
        ...
        function G(e) {
            if (g.isOpen && !g.config.inline) {
                ...
                i && o && (x(), g.close(), "range" === g.config.mode && 1 === g.selectedDates.length && (g.clear(!1), g.redraw()))
            }
            var r
        }
        ...
        function X(e) {
            ...
            if (13 === e.keyCode && t) {
                ...
                switch (e.keyCode) {
                    ...
                    case 40:
                        ...
                        break;
                    case 9:
                        var c = g.calendarContainer.childElementCount, d = 0;
                        if (g.config.enableTime && (d += 1), g.config.noCalendar || (d += 2), o) {
                            var s = [g.hourElement, g.minuteElement, g.secondElement, g.amPM].filter(function (e) {
                                return e
                            }), u = s.indexOf(e.target);
                            if (-1 !== u) {
                                var f = s[u + (e.shiftKey ? -1 : 1)];
                                void 0 !== f ? (e.preventDefault(), f.focus()) : c <= d && g.element.focus()
                            }
                            break
                        }
                        c <= d && g.element.focus()
            ...
            if (void 0 !== g.amPM && e.target === g.amPM) switch (e.key) {
                ...
                case g.l10n.amPM[0].charAt(0).toLowerCase():
                    g.amPM.textContent = g.l10n.amPM[0], T(), he();
                    break;
                case g.l10n.amPM[1].charAt(0):
                case g.l10n.amPM[1].charAt(0).toLowerCase():
                    g.amPM.textContent = g.l10n.amPM[1], T(), he()
            }
            ue("onKeyDown", e)
        }
        ...
        function ne(e) {
            return function (t) {
                ...
                void 0 !== n && (g["min" === e ? "minDateHasTime" : "maxDateHasTime"] = n.getHours() > 0 || n.getMinutes() > 0 || n.getSeconds() > 0), g.selectedDates && (g.selectedDates = g.selectedDates.filter(function (e) {
                    return Z(e)
                }), g.selectedDates.length || "min" !== e || k(n), he()), g.daysContainer && (oe(), void 0 !== n ? g.currentYearElement[e] = n.getFullYear().toString() : g.currentYearElement.removeAttribute(e), g.currentYearElement.disabled = !!a && void 0 !== n && a.getFullYear() === n.getFullYear())
            }
        }
            ...
            if (void 0 !== g.calendarContainer) {
                ...
                if (c(g.calendarContainer, "arrowTop", !s), c(g.calendarContainer, "arrowBottom", s), !g.config.inline) {
                    ...
                    if (c(g.calendarContainer, "rightMost", p), !g.config.static) if (g.calendarContainer.style.top = u + "px", p) if (h) {
                        var v = document.styleSheets[0], D = window.document.body.offsetWidth,
                            w = Math.max(0, D / 2 - a / 2), b = v.cssRules.length,
                            C = "{left:" + l.left + "px;right:auto;}";
                        c(g.calendarContainer, "rightMost", !1), c(g.calendarContainer, "centerMost", !0), v.insertRule(".flatpickr-calendar.centerMost:before,.flatpickr-calendar.centerMost:after" + C, b), g.calendarContainer.style.left = w + "px", g.calendarContainer.style.right = "auto"
        ...
        function oe() {
            g.config.noCalendar || g.isMobile || (ge(), B())
        }
        ...
        function le(e) {
            ...
            if (void 0 !== t) {
                ...
                } else "range" === g.config.mode && (2 === g.selectedDates.length && g.clear(!1), g.latestSelectedDateObj = a, g.selectedDates.push(a), 0 !== w(a, g.selectedDates[0], !0) && g.selectedDates.sort(function (e, t) {
                    return e.getTime() - t.getTime()
                }));
                if (T(), i) {
                    var r = g.currentYear !== a.getFullYear();
                    g.currentYear = a.getFullYear(), g.currentMonth = a.getMonth(), r && ue("onYearChange"), ue("onMonthChange")
                }
                if (ge(), B(), he(), g.config.enableTime && setTimeout(function () {
        ...
        g.parseDate = D({
            config: g.config,
            l10n: g.l10n
        }), g._handlers = [], g._bind = _, g._setHoursFromDate = k, g._positionCalendar = ie, g.changeMonth = $, g.changeYear = V, g.clear = function (e) {
            void 0 === e && (e = !0);
            g.input.value = "", void 0 !== g.altInput && (g.altInput.value = "");
            void 0 !== g.mobileInput && (g.mobileInput.value = "");
            g.selectedDates = [], g.latestSelectedDateObj = void 0, g.currentYear = g._initialDate.getFullYear(), g.currentMonth = g._initialDate.getMonth(), g.showTimeInput = !1, !0 === g.config.enableTime && I();
            g.redraw(), e && ue("onChange")
        }, g.close = function () {
            ...
            if (!0 === g.isMobile) return e && (e.preventDefault(), e.target && e.target.blur()), void 0 !== g.mobileInput && (g.mobileInput.focus(), g.mobileInput.click()), void ue("onOpen");
            if (g._input.disabled || g.config.inline) return;
            var n = g.isOpen;
            g.isOpen = !0, n || (g.calendarContainer.classList.add("open"), g._input.classList.add("active"), ue("onOpen"), ie(t), g.calendarContainer.focus(), !1 === g.config.noCalendar && W(void 0, 0));
            !0 === g.config.enableTime && !0 === g.config.noCalendar && (0 === g.selectedDates.length && (g.setDate(void 0 !== g.config.minDate ? new Date(g.config.minDate.getTime()) : new Date, !1), I(), he()), !1 !== g.config.allowInput || void 0 !== e && g.timeContainer.contains(e.relatedTarget) || setTimeout(function () {
                return g.hourElement.select()
            }, 50))
        }, g.redraw = oe, g.set = function (e, n) {
            null !== e && "object" == typeof e ? Object.assign(g.config, e) : (g.config[e] = n, void 0 !== ce[e] ? ce[e].forEach(function (e) {
                return e()
            ...
            de(e, n), g.showTimeInput = g.selectedDates.length > 0, g.latestSelectedDateObj = g.selectedDates[0], g.redraw(), P(), k(), he(t), t && ue("onChange")
        }, g.toggle = function (e) {
            if (!0 === g.isOpen) return g.close();
            g.open(e)
        };
        var ce = {locale: [ae, q], showMonths: [J, M, U]};
        ...
        function ue(e, t) {
            if (void 0 !== g.config) {
                ...
                "onChange" === e && (g.input.dispatchEvent(fe("change")), g.input.dispatchEvent(fe("input")))
            }
        }
        ...
        function he(e) {
            ...
            void 0 !== g.mobileInput && g.mobileFormatStr && (g.mobileInput.value = void 0 !== g.latestSelectedDateObj ? g.formatDate(g.latestSelectedDateObj, g.mobileFormatStr) : ""), g.input.value = pe(g.config.dateFormat), void 0 !== g.altInput && (g.altInput.value = pe(g.config.altFormat)), !1 !== e && ue("onValueUpdate")
        }
        ...
        return function () {
            g.element = g.input = n, g.isOpen = !1, function () {
                ...
                e && de(e, g.config.dateFormat), g._initialDate = g.selectedDates.length > 0 ? g.selectedDates[0] : g.config.minDate && g.config.minDate.getTime() > g.now.getTime() ? g.config.minDate : g.config.maxDate && g.config.maxDate.getTime() < g.now.getTime() ? g.config.maxDate : g.now, g.currentYear = g._initialDate.getFullYear(), g.currentMonth = g._initialDate.getMonth(), g.selectedDates.length > 0 && (g.latestSelectedDateObj = g.selectedDates[0]), void 0 !== g.config.minTime && (g.config.minTime = g.parseDate(g.config.minTime, "H:i")), void 0 !== g.config.maxTime && (g.config.maxTime = g.parseDate(g.config.maxTime, "H:i")), g.minDateHasTime = !!g.config.minDate && (g.config.minDate.getHours() > 0 || g.config.minDate.getMinutes() > 0 || g.config.minDate.getSeconds() > 0), g.maxDateHasTime = !!g.config.maxDate && (g.config.maxDate.getHours() > 0 || g.config.maxDate.getMinutes() > 0 || g.config.maxDate.getSeconds() > 0), Object.defineProperty(g, "showTimeInput", {
                    get: function () {
                        ...
                        g._showTimeInput = e, g.calendarContainer && c(g.calendarContainer, "showTimeInput", e), g.isOpen && ie()
                    }
                })
            }(), g.utils = {
                ...
                if (g.calendarContainer = d("div", "flatpickr-calendar"), g.calendarContainer.tabIndex = -1, !g.config.noCalendar) {
                    ...
                    }), g.currentYearElement = g.yearElements[0], ge(), g.monthNav)), g.innerContainer = d("div", "flatpickr-innerContainer"), g.config.weekNumbers) {
                        var t = function () {
                ...
                g.config.enableTime && e.appendChild(function () {
                    ...
                    }(g.config.defaultHour)), g.minuteElement.value = i(g.latestSelectedDateObj ? g.latestSelectedDateObj.getMinutes() : g.config.defaultMinute), g.hourElement.setAttribute("data-step", g.config.hourIncrement.toString()), g.minuteElement.setAttribute("data-step", g.config.minuteIncrement.toString()), g.hourElement.setAttribute("data-min", g.config.time_24hr ? "0" : "1"), g.hourElement.setAttribute("data-max", g.config.time_24hr ? "23" : "12"), g.minuteElement.setAttribute("data-min", "0"), g.minuteElement.setAttribute("data-max", "59"), g.timeContainer.appendChild(t), g.timeContainer.appendChild(e), g.timeContainer.appendChild(n), g.config.time_24hr && g.timeContainer.classList.add("time24hr"), g.config.enableSeconds) {
                ...
                if (g.config.wrap && ["open", "close", "toggle", "clear"].forEach(function (e) {
                    ...
                    _(g.mobileInput, "change", function (e) {
                        g.setDate(e.target.value, !1, g.mobileFormatStr), ue("onChange"), ue("onClose")
                    })
                }(); else {
                    var e = r(te, 50);
                    g._debouncedChange = r(F, y), g.daysContainer && !/iPhone|iPad|iPod/i.test(navigator.userAgent) && _(g.daysContainer, "mouseover", function (e) {
            ...
            }(), (g.selectedDates.length || g.config.noCalendar) && (g.config.enableTime && k(g.config.noCalendar ? g.latestSelectedDateObj || g.config.minDate : void 0), he(!1)), M(), g.showTimeInput = g.selectedDates.length > 0 || g.config.noCalendar;
            var a = /^((?!chrome|android).)*safari/i.test(navigator.userAgent);
            !g.isMobile && a && ie(), ue("onReady")
        }(), g
    }

    function x(e, t) {
        if (0 === e.length) return [];
        for (var n = Array.from(e).filter(function (e) {
