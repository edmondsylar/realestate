(function (root, factory) {
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        if (typeof options.singleDatePicker === 'boolean') {
            ...
            if (this.singleDatePicker && this.sameDate)
        ...
        this.container.find('.calendar-time').on('change.daterangepicker', 'select.timepicker', $.proxy(this.timeChanged, this));
    ...
    DateRangePicker.prototype = {
        constructor: DateRangePicker, setStartDate: function (startDate) {
            ...
            this.element.trigger('daterangepicker_click_nav', ['prev', this]);
            this.updateCalendars();
            ...
            this.element.trigger('daterangepicker_click_nav', ['next', this]);
            this.updateCalendars();
            ...
            var cal = $(e.target).closest('.calendar-time'), isLeft = cal.hasClass('left');
