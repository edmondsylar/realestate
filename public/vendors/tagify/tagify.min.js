...
!function (t, e) {
    "function" == typeof define && define.amd ? define([], e) : "object" == typeof exports ? module.exports = e() : t.Tagify = e()
}(this, function () {
    "use strict";
    ...
    return t.prototype = {
        ...
        applySettings: function (t, e) {
            var i = t.getAttribute("data-whitelist"), s = t.getAttribute("data-blacklist");
        ...
        escapeHTML: function (t) {
            ...
            var e = document.createTextNode(t), i = document.createElement("p");
            return i.appendChild(e), i.innerHTML
        },
        build: function (t) {
            var e = this.DOM, i = this.settings.templates.wrapper(t, this.settings);
        ...
        events: {
            customBinding: function () {
                ...
                var e, i = !(0 < arguments.length && void 0 !== t) || t, s = this.events.callbacks,
                ...
                }, a, ["scope", s.onDoubleClickScope.bind(this)])) this.DOM[e[o][0]][n](o.replace(/_/g, ""), e[o][1]);
                ...
                onFocusBlur: function (t) {
                    ...
                    var e, i = this, s = t.target.textContent.trim();
                    if ("mix" == this.settings.mode) {
                        switch (t.key) {
                            case"Delete":
                            case"Backspace":
                    ...
                    var e = "mix" == this.settings.mode ? this.DOM.input.textContent : this.input.normalize.call(this),
                        i = e.length >= this.settings.dropdown.enabled, s = {value: e, inputElm: this.DOM.input};
                    if ("mix" == this.settings.mode) return this.events.callbacks.onMixTagsInput.call(this, t);
                    e ? this.input.value != e && (s.isValid = this.validateTag(e), this.input.set.call(this, e, !1), -1 != e.search(this.settings.delimiters) ? this.addTags(e).length && this.input.set.call(this) : 0 <= this.settings.dropdown.enabled && this.dropdown[i ? "show" : "hide"].call(this, e), this.trigger("input", s)) : this.input.set.call(this, "")
                    ...
                    }, n = this.state.tag, a = this.state.tag.value.length >= this.settings.dropdown.enabled)), this.update(), setTimeout(this.trigger.bind(this, "input", this.extend({}, this.state.tag, {textContent: this.DOM.input.textContent})), 30), this.state.tag && this.dropdown[a ? "show" : "hide"].call(this, this.state.tag.value)
                    ...
                    if ("TAGS" == t.target.tagName) this.DOM.input.focus(); else {
                        ...
                        i && (e = this.getNodeIndex(i), this.trigger("click", {tag: i, index: e, data: this.value[e]}))
                    }
                    "select" != this.settings.mode && 0 !== this.settings.dropdown.enabled || this.dropdown.show.call(this)
                }, onEditTagInput: function (t) {
                    var e = t.closest("tag"), i = this.getNodeIndex(e), s = this.input.normalize(t),
                    ...
                    e.classList.toggle("tagify--invalid", !0 !== n), e.isValid = n, this.trigger("input", {
                        tag: e,
                        index: i,
                        data: this.extend({}, this.value[i], {newValue: s})
                    })
                }, onEditTagBlur: function (t) {
                    var e = t.closest("tag"), i = this.getNodeIndex(e), s = this.input.normalize(t),
                        n = s || t.originalValue, a = this.input.normalize(t) != t.originalValue, o = e.isValid,
                        r = u({}, this.value[i], {value: n});
                    ...
                    var e, i, s = t.target.closest("tag"), n = this.settings;
        ...
        editTag: function (t) {
            var e = this, i = 0 < arguments.length && void 0 !== t ? t : this.getLastTag(),
                s = i.querySelector(".tagify__tag-text"), n = this.events.callbacks;
        ...
        editTagDone: function (t, e) {
            var i, s = t.querySelector(".tagify__tag-text"), n = s.cloneNode(!0);
            n.removeAttribute("contenteditable"), t.classList.remove("tagify--editable"), s.parentNode.replaceChild(n, s), e && (s.textContent = esc_html(e.value), t.title = esc_html(e.value), i = this.getNodeIndex(t), this.value[i].value = esc_html(e.value), this.update())
        },
        ...
        input: {
            value: "", set: function (t, e, i) {
                var s = 0 < arguments.length && void 0 !== t ? t : "", n = !(1 < arguments.length && void 0 !== e) || e,
                ...
                suggest: function (t) {
                    ...
                    var e = this.DOM.input.getAttribute("data-suggest"), i = t || (e ? this.input.value + e : null);
        ...
        normalizeTags: function (t) {
            ...
            var e, s = this.settings, n = s.whitelist, a = s.delimiters, o = s.mode, r = !!n && n[0] instanceof Object,
                l = t instanceof Array && t[0] instanceof Object && "value" in t[0], d = [];
        ...
        parseMixTags: function (t) {
            var a = this, e = this.settings, o = e.mixTagsInterpolator, r = e.duplicates, l = e.transformTag;
            return t = t.split(o[0]).map(function (t) {
                var e, i, s = t.split(o[1]), n = s[0];
                try {
                    e = JSON.parse(n)
                } catch (t) {
        ...
        addMixTag: function (t) {
            if (t && this.state.tag) {
                for (var e, i, s, n, a = this.state.tag.prefix + this.state.tag.value, o = document.createNodeIterator(this.DOM.input, NodeFilter.SHOW_TEXT, null, !1), r = 100; (e = o.nextNode()) && r--;) if (e.nodeType === Node.TEXT_NODE) {
        ...
        addTags: function (t, n, e) {
            var a = this, o = 2 < arguments.length && void 0 !== e ? e : this.settings.skipInvalid, r = [];
        ...
        getAttributes: function (t) {
            ...
            var e, i, s = Object.keys(t), n = "";
            for (i = s.length; i--;) "class" != (e = s[i]) && t.hasOwnProperty(e) && t[e] && (n += " " + e + (t[e] ? '="'.concat(esc_html(t[e]), '"') : ""));
            return n
        },
        preUpdate: function () {
        ...
        getMixedTagsAsString: function () {
            var e = this, i = "", s = 0, n = this.settings.mixTagsInterpolator;
        ...
        dropdown: {
            init: function () {
                ...
                var t = this.settings.dropdown, e = t.position, i = t.classname,
                    s = "".concat("manual" == e ? "" : "tagify__dropdown", " ").concat(i).trim(),
                    n = '<div class="'.concat(s, '" role="menu"></div>');
                return this.parseHTML(n)
            }, show: function (t) {
                var e, i, s, n = this.settings, a = "manual" == n.dropdown.position;
                ...
                var e = this.DOM, i = e.scope, s = e.dropdown, n = "manual" == this.settings.dropdown.position && !t;
                ...
                binding: function (t) {
                    var e = !(0 < arguments.length && void 0 !== t) || t, i = this.dropdown.events.callbacks,
                    ...
                    onKeyDown: function (t) {
                        var e = this, i = this.DOM.dropdown.querySelector("[class$='--active']"), s = i, n = "";
                        switch (t.key) {
                            case"ArrowDown":
                            case"ArrowUp":
                            case"Down":
                ...
                var e, i, s, n, a = this, o = [], r = this.settings.whitelist,
                    l = this.settings.dropdown.maxItems || 1 / 0, d = 0;
                if (!t) return r.filter(function (t) {
                    return !a.isTagDuplicate(t.value || t)
                }).slice(0, l);
                for (; d < r.length && (s = (((e = r[d] instanceof Object ? r[d] : {value: r[d]}).searchBy || "") + " " + e.value).toLowerCase().indexOf(t.toLowerCase()), i = this.settings.dropdown.fuzzySearch ? 0 <= s : 0 == s, n = !this.settings.duplicates && this.isTagDuplicate(e.value), i && !n && l-- && o.push(e), 0 != l); d++) ;
                return o
