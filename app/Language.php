...
class Language extends Model
{
    ...
    public function getAllLanguages($data = [])
    {
        ...
        $sql = DB::table($this->getTable())->selectRaw("SQL_CALC_FOUND_ROWS language.*")
    ...
    {
        return DB::table($this->getTable())->where('id', $language_id)->update($data);
    }

    public function getById($language_id)
    {
        return DB::table($this->table)->where('id', $language_id)->get()->first();
    }

    public function deleteLanguage($language_id)
    {
        return DB::table($this->table)->where('id', $language_id)->delete();
    }
}
