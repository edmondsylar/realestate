...
class CouponController extends Controller
{
    ...
    public function _removeCouponFromCart(Request $request)
    {
        ...
        \CartHome::get_inst()->setCart($cart);
    ...
    {
        $coupon_code = Input::get('coupon');
        $home_id = Input::get('homeID');

        $serviceObject = get_post($home_id, 'home');
        ...
        $amount = \CartHome::get_inst()->getAmount($subTotal, $taxRule);
    ...
    public function _getCouponItem(Request $request)
    {
        ...
        $coupon_encrypt = Input::get('couponEncrypt');
    ...
    public function _updateCouponItem(Request $request)
    {
        ...
        if (!empty($couponObject) && is_object($couponObject)) {
            ...
            $price_type = Input::get('coupon_type', 'fixed');
            $coupon_price = Input::get('coupon_price', 0);
            $coupon_start = Input::get('coupon_start', '');
            $coupon_end = Input::get('coupon_end', '');
    ...
    public function _allCoupon(Request $request, $page = 1)
    {
        ...
        $search = Input::get('_s');
        $orderBy = Input::get('orderby', 'coupon_id');
