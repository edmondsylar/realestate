        ...
        if (!empty($response)) {
            if ($response->status == 400) {
                ...
                return [
                    'status' => 1,
                    'title' => 'Alert System',
                    'message' => '<div class="text text-success">Subscribe successfully. Thanks for registering for our email list</div>',
                ];
            } else {
                return [
                    'status' => 0,
                    'title' => 'Alert System',
                    'message' => '<div class="text text-danger">Have an error when submit this form</div>'
                ];
            }
        } else {
            return [
