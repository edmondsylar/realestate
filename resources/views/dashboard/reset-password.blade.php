            ...
            <div class="col-md-8 col-lg-6 col-xl-5">
                <div class="card bg-pattern">
                    <div class="card-body p-4">
                        ...
                        <form id="hh-reset-password-form" action="{{ url('auth/reset-password') }}" method="post" data-reload-time="1500"
                            ...
                            <div class="form-group mb-0 text-center">
                                <button class="btn btn-primary btn-block text-uppercase" type="submit"> {{__('Reset Password')}} </button>
                            </div>
                ...
                <div class="row mt-3">
                    <div class="col-12 text-center">
                        <p class="text-white-50">{{__('Back to')}} <a href="{{ url('auth/login') }}" class="text-white ml-1"><b>{{__('Login')}}</b></a></p>
                    </div> <!-- end col -->
                </div>
                <!-- end row -->
