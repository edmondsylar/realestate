        ...
        <div class="content">
            ...
            <div class="card-box">
                ...
                <table class="table table-large mb-0 dt-responsive nowrap w-100" data-plugin="datatable"
                    ...
                    <tbody>
                    @if ($allHomeAmenities['total'])
                        @foreach ($allHomeAmenities['results'] as $item)
                            <tr>
                                ...
                                <td class="align-middle">
                                    <p class="mb-0"><i class="text-muted">{{ get_translate($item->term_description) }}</i>
                                    </p>
                                </td>
                                <td class="align-middle">
                                    @php
                ...
                <div class="clearfix">
                    {{ dashboard_pagination(['total' => $allHomeAmenities['total']]) }}
                </div>
            </div>
            <div id="hh-update-home-amenity-modal" class="modal fade hh-get-modal-content" tabindex="-1" role="dialog" aria-hidden="true"
                 data-url="{{ dashboard_url('get-home-amenity-item') }}">
