            ...
            <div class="card-box">
                ...
                <table class="table table-large mb-0 dt-responsive nowrap w-100" data-plugin="datatable"
                    ...
                    <tr>
                        ...
                        <th data-priority="5" class="text-center">{{__('No. Guest')}}</th>
                        <th data-priority="6">{{__('Home Type')}}</th>
                    ...
                    @if ($allHomes['total'])
                        @foreach ($allHomes['results'] as $item)
                            ...
                            <tr>
                                <td class="align-middle">
                                    <div class="media align-items-center">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <p class="text-muted mb-0 mt-2 d-none d-md-block">{{ get_translate($item->location_address) }}</p>
                                        </div>
                                    </div>
                                </td>
                                <td class="align-middle">
                                    {{ convert_price($item->base_price) }}
                                </td>
                                <td class="align-middle text-center">
                                    <div class="service-status {{ $item->status }} status-icon"
                                         ...
                                         data-original-title="{{ service_status_info($item->status)['name'] }}"><span
                                                class="d-none">{{ service_status_info($item->status)['name'] }}</span>
                                    </div>
                                </td>
                                <td class="align-middle text-center">
                                ...
                                <td class="align-middle">
                                    @if($term) {{ get_translate($term->term_title) }} @endif
                                </td>
                                <td class="align-middle text-center">
                        ...
                        <tr>
                            <td colspan="7">
                                <h4 class="mt-3 text-center">{{__('No homes yet.')}}</h4>
                            </td>
                        </tr>
                    @endif
                    </tbody>
