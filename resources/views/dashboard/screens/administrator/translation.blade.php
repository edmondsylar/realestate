...
@php
    ...
    $lang = \Illuminate\Support\Facades\Input::get('lang', 'none');
            ...
            <div class="card-box page-translation">
                ...
                <form action="{{ dashboard_url('update-translate') }}" class="form form-action" method="post">
                    ...
                    <div class="d-flex mb-3 justify-content-between">
                        ...
                        <select id="hh-choose-langs" class="form-control form-control-sm" name="lang" data-url="{{ dashboard_url('translation') }}">
                            ...
                            <tbody>
                                @foreach($strings as $k => $v)
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class="form-control form-control-sm" name="trans[{{ $v }}]" value="{{ isset($trans[$v]) ? $trans[$v] : '' }}"/>
