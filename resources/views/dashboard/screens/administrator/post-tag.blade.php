        ...
        <div class="content">
            ...
            <div class="card-box">
                ...
                <table class="table table-large mb-0 dt-responsive nowrap w-100" data-plugin="datatable"
                    ...
                    <tbody>
                    @if ($allTags['total'])
                        @foreach ($allTags['results'] as $item)
                            <tr>
                ...
                <div class="clearfix">
                    {{ dashboard_pagination(['total' => $allTags['total']]) }}
                </div>
            </div>
            <div id="hh-update-post-tags-modal" class="modal fade hh-get-modal-content" tabindex="-1" role="dialog" aria-hidden="true"
