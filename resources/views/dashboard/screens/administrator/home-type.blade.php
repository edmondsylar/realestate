        ...
        <div class="content">
            ...
            <div class="card-box">
                ...
                <table class="table table-large mb-0 dt-responsive nowrap w-100" data-plugin="datatable"
                    ...
                    <tbody>
                    @if ($allHomeTypes['total'])
                        @foreach ($allHomeTypes['results'] as $item)
                            @php
                ...
                <div class="clearfix">
                    {{ dashboard_pagination(['total' => $allHomeTypes['total']]) }}
                </div>
            </div>
            <div id="hh-update-home-types-modal" class="modal fade hh-get-modal-content" tabindex="-1" role="dialog" aria-hidden="true"
                 data-url="{{ dashboard_url('get-home-type-item') }}">
