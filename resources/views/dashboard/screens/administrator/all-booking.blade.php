                ...
                <table class="table  table-large mb-0 dt-responsive nowrap w-100" data-plugin="datatable"
                    ...
                    @if ($allBooking['total'])
                        @foreach ($allBooking['results'] as $item)
                            ...
                            @endphp
                            <tr>
                                <td><span class="exp">{{ $ID }}</span></td>
                                <td class="align-middle"><span class="exp">{{ sprintf(__('Booking for %s'), get_translate($item->booking_description)) }}</span></td>
                                <td class="align-middle text-center">
                                    <div class="booking-status exp {{ $item->status }}">{{ $bookingStatus['label'] }}</div>
                                </td>
                                <td class="align-middle text-center">
                                ...
                                <td class="align-middle">
                                    ...
                                    @endphp
                                    <span class="exp">{!! balanceTags(date(hh_date_format(), $checkIn)) . '<span class="d-none"> - </span><i class="fe-arrow-right ml-2 mr-2"></i>' . balanceTags(date(hh_date_format(), $checkOut)) !!}</span>
                                </td>
                                <td class="align-middle">
                                    <span class="exp">{{ balanceTags(date(hh_date_format(), $item->created_date)) }}</span>
                                </td>
                                <td class="align-middle text-center">
