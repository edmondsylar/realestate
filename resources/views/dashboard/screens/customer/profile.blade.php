                        ...
                        <form action="{{ dashboard_url('update-your-avatar') }}" class="form form-action">
                            ...
                            <div class="avatar-preview">
                                <div class="media align-items-center mb-2">
                                    <img src="{{ get_user_avatar($user_id, [85,85]) }}" class="avatar" alt="{{__('Avatar')}}">
                                ...
                                <div class="hh-upload-wrapper d-none">
                                    <div class="hh-upload-wrapper clearfix">
                                        ...
                                        <div class="mt-1">
                                            ...
                                            <input type="hidden" name="avatar" class="upload_value input-upload" data-size="85" data-url="{{ dashboard_url('get-attachments') }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card relative p-3">
                        <form action="{{ dashboard_url('update-password') }}" class="form form-action mt-1"
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <label for="new_re_password">{{__('Password Confirmation')}}</label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        @endphp
                                        <select name="location" id="location" class="form-control wide" data-plugin="customselect">
