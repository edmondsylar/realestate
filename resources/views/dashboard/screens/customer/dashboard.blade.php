    ...
    <div class="content-page">
        <div class="content">
            ...
            <div class="page-title-box">
                <h4 class="page-title">{{ __('Welcome :username', ['username' => get_username($user->getUserId())]) }}!</h4>
            </div>
            <div class="card-columns card-1 card-md-2">
                <div class="card card-box">
                    ...
                    <div class="hh-slimscroll" data-max-height="350px" data-min-height="150px">
                        ...
                        @endphp
                        <table class="table table-large mb-0 dt-responsive nowrap w-100 @if($allBooking['total'] <= 0) no-data @endif"
                ...
                <div class="card card-box">
                    ...
                    <div class="hh-slimscroll" data-max-height="350px" data-min-height="150px">
                        ...
                        @php
                            $allNotifications = \App\Http\Controllers\NotificationController::get_inst()->allNotifications([]);
                        @endphp
                        <table class="table table-large mb-0 dt-responsive nowrap w-100 @if($allNotifications['total'] <= 0) no-data @endif"
                               data-plugin="datatable"
                               data-pdf="off" data-pdf-name="{{__('Export to PDF')}}"
                               data-paging="false"
                               data-ordering="false">
            ...
            @php
                $unique = time();
            @endphp
            <div class="card-columns card-1">
                <div class="card">
                    <div class="card-body">
                        <div class="card-widgets">
                            <a href="javascript: void(0);" data-toggle="hh-reload"
                               data-target="#hh-get-home-near-by-{{$unique}}"><i class="mdi mdi-refresh"></i></a>
                            <a data-toggle="collapse" href="#cardCollpase-latest-homes" role="button"
                               aria-expanded="false"
                               aria-controls="cardCollpase-latest-homes"><i class="mdi mdi-minus"></i></a>
                        </div>
                        <h4 class="header-title mb-0">Near you</h4>
                        <div id="cardCollpase-latest-homes" class="collapse pt-3 show">
                            <div id="hh-get-home-near-by-{{$unique}}" class="hh-load-delay hh-get-home-near-by relative"
                                 data-data="{{ base64_encode(json_encode([])) }}" data-from="js" data-radius="50"
                                 data-unique="{{ time().rand(1,9999) }}"
                                 data-action="{{ url('get-home-near-you-ajax') }}" data-min-height="50px">
                                @include('common.loading-square')
            ...
            <div class="card-columns card-1">
                <div class="card">
                    <div class="card-body">
                        <div class="card-widgets">
                            <a href="javascript: void(0);" data-toggle="hh-reload"
                               data-target="#hh-get-latest-home-{{$unique}}"><i class="mdi mdi-refresh"></i></a>
                            <a data-toggle="collapse" href="#cardCollpase-latest-homes" role="button"
                               aria-expanded="false"
                               aria-controls="cardCollpase-latest-homes"><i class="mdi mdi-minus"></i></a>
                        </div>
                        <h4 class="header-title mb-0">{{__('The Latest Homes')}}</h4>
                        <div id="cardCollpase-latest-homes" class="collapse pt-3 show">
                            <div id="hh-get-latest-home-{{$unique}}" class="hh-load-delay hh-get-latest-home relative"
                                 data-data="{{ base64_encode(json_encode([])) }}" data-from=""
                                 data-unique="{{  time().rand(1,9999) }}"
                                 data-action="{{ url('get-latest-home-ajax') }}" data-min-height="50px">
                                @include('common.loading-square')
                                <div class="render"></div>
                            </div>
                        </div> <!-- collapsed end -->
