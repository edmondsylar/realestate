...
<div class="hh-email-wrapper">
    ...
    <div class="content-email">
        ...
        <p>{{sprintf(__('Hello %s'), '<strong>' . get_username($user->getUserId()) . '</strong>')}} ,</p>
        <p>{{sprintf(__('Welcome to the website %s'), '<a href="' . url('/') . '">' . get_option('site_name') .'</a>')}} </p>
        <p>{{__('Here is your information:')}}</p>
