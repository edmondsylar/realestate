...
<div class="hh-email-wrapper">
    ...
    <div class="content-email">
        @if($for == 'customer')
            <p>{{sprintf(__('Hello %s'), '<strong>' . $booking->first_name . ' ' . $booking->last_name . '</strong>')}} ,</p>
        ...
        @elseif($for == 'admin')
            ...
            @endphp
            <p>{{sprintf(__('Hello %s'), '<strong>' . $admin_data->first_name . ' ' . $admin_data->last_name . '</strong>')}} ,</p>
            <p>{{__('There is a new booking on your system')}}</p>
        @elseif($for == 'partner')
            @php
                $partner_data = get_user_by_id($booking->owner);
            @endphp
            <p>{{ sprintf(__('Hello %s'), '<strong>'. $partner_data->first_name . ' ' . $partner_data->last_name .'</strong>') }},</p>
        ...
        <div class="booking-detail">
            ...
            <div class="item">
                ...
                <span class="info">{{ $service_data->post_title }}</span>
            </div>
            <div class="item">
            ...
            <div class="item">
                ...
                <span class="info">
                    ...
                    @endphp
                    <span class="booking-status {{ $status }}">{{ $status_info['label'] }}</span>
                </span>
            </div>
            <div class="item">
                ...
                <div class="info">
                    ...
                    <ul class="menu cart-list">
                        ...
                        <li class="divider">
                            ...
                            <span>{{ $checkout_data['tax']['tax'] }}%</span>
                        </li>
                        <li class="amount">
                            <span>{{__('Amount')}}</span>
        ...
        <div class="text-center">
            <a class="button-primary confirmation-button"
               href="{{ dashboard_url('all-booking') }}">{{__('All Bookings')}}</a>
        </div>
    </div>
