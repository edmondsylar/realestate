            ...
            <div class="col-lg-5">
                <div class="card">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="text-center">
                            <h3 class="mt-4">{{__('Page not found')}} </h3>
                            <p class="text-muted mb-0">{{__("It's looking like you may have taken a wrong turn. Don't worry... it happens to the best of us. You might want to check your internet connection. Here's a little tip that might help you get back on track.")}}</p>
                        </div>
                ...
                <div class="row mt-3">
                    <div class="col-12 text-center">
                        <p class="text-white-50">{{__('Return to')}} <a href="{{ url('/') }}" class="text-white ml-1"><b>{{__('Home page')}}</b></a></p>
                    </div> <!-- end col -->
                </div>
                <!-- end row -->
...
<footer class="footer footer-alt">
    {{ date('Y') }} &copy; by <a href="{{ url('/') }}" class="text-white-50">{{ get_option('site_name', 'AweBooking') }}</a>
</footer>
